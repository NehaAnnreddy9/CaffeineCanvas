...
{
    [DbContext(typeof(CaffeineCanvasDBContext))]
    partial class CaffeineCanvasDBContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaffeineCanvas.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CaffeineCanvas.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("CaffeineCanvas.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CaffeineCanvas.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CaffeineCanvas.Models.OrderDetail", b =>
                {
                    b.HasOne("CaffeineCanvas.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CaffeineCanvas.Models.Product", "Product")
                        .WithMany()
